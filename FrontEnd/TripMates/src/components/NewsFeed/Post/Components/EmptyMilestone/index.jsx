const EmptyMilestone = () => {
  return (
    <div className="flex flex-col items-center justify-center gap-[2rem] border-2 rounded p-10">
      ...
      <button className="font-bold text-white bg-[#5143d9] px-5 py-1 text-2xl text-center cursor-pointer outline-none border-none rounded-lg shadow-md active:bg-[#5143d9] active:scale-95">
        +
      </button>
